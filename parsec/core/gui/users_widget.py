...
from parsec.core.logged_core import InviteListItem, LoggedCore
...
class UserButton(QWidget, Ui_UserButton):
    ...
    @user_info.setter  # type: ignore[no-redef, attr-defined]
    def user_info(self, val: UserInfo) -> None:  # type: ignore[misc]
        profiles_txt = {
