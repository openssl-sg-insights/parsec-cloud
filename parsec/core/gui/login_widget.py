...
class EnrollmentPendingButton(QWidget, Ui_EnrollmentPendingButton):
    ...
    def __init__(self, config: CoreConfig, jobs_ctx: Any, context: Any) -> None:
        super().__init__()
        self.setupUi(self)
        self.config = config
...
class LoginAccountsWidget(QWidget, Ui_LoginAccountsWidget):
    ...
    def __init__(self, config: CoreConfig, jobs_ctx: Any, devices: list[Any], pendings: list[Any]):
        super().__init__()
        self.setupUi(self)
    ...
    def _on_pending_clear_clicked(self, pending: Any) -> None:
        self.pending_clear_clicked.emit(pending)

    def _on_pending_finalize_clicked(self, pending: Any) -> None:
...
class LoginSmartcardInputWidget(QWidget, Ui_LoginSmartcardInputWidget):
    ...
    def __init__(self, device: Any, hide_back: bool = False):
        super().__init__()
        self.setupUi(self)
        self.device = device
        if hide_back:
...
class LoginPasswordInputWidget(QWidget, Ui_LoginPasswordInputWidget):
    ...
    def __init__(self, device: Any, hide_back: bool = False) -> None:
        super().__init__()
        self.setupUi(self)
        self.device = device
        if hide_back:
...
class LoginWidget(QWidget, Ui_LoginWidget):
    ...
    async def _finalize_enrollment(self, context: Any) -> None:
        try:
    ...
    async def _remove_enrollment(self, context: Any) -> None:
        try:
    ...
    def _on_account_clicked(self, device: Any, hide_back: bool = False) -> None:
        self._clear_widget()
    ...
    def try_login_with_password(self, device: Any, password: str) -> None:
        self.login_with_password_clicked.emit(device.key_file_path, password)

    def try_login_with_smartcard(self, device: Any) -> None:
