...
async def _do_workspace_version(
    version_lister: Any, path: FsPath, core: LoggedCore
) -> Tuple[list[Tuple[UserInfo, object]], bool]:
...
class FileHistoryWidget(QWidget, Ui_FileHistoryWidget):
    ...
    def __init__(
        ...
        path: FsPath,
        reload_timestamped_signal: Any,
        update_version_list: Any,
        close_version_list: Any,
        core: LoggedCore,
    ) -> None:
        super().__init__()
        self.setupUi(self)
    ...
    def reset_dialog(self, workspace_fs: WorkspaceFS, version_lister: Any, path: FsPath) -> None:
