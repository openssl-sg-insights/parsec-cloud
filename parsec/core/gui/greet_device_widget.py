...
class GreetDeviceInstructionsWidget(QWidget, Ui_GreetDeviceInstructionsWidget):
    ...
    def __init__(
        self, jobs_ctx: Any, greeter: Any, invite_addr: BackendInvitationAddr, core: LoggedCore
    ) -> None:
        super().__init__()
        self.setupUi(self)
...
class GreetDeviceWidget(QWidget, Ui_GreetDeviceWidget):
    ...
    def __init__(self, core: LoggedCore, jobs_ctx: Any, invite_addr: BackendInvitationAddr) -> None:
        super().__init__()
        self.setupUi(self)
        self.core = core
        self.jobs_ctx = jobs_ctx
    ...
    @classmethod
    def show_modal(cls, core: LoggedCore, jobs_ctx: Any, invite_addr: BackendInvitationAddr, parent: QWidget, on_finished: Callable[..., None]) -> GreetDeviceWidget:  # type: ignore[misc]
