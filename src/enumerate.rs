...
use libparsec::protocol::authenticated_cmds::invite_new;
...
impl InvitationEmailSentStatus {
    #[classattr]
    #[pyo3(name = "SUCCESS")]
    pub fn success() -> &'static PyObject {
        lazy_static::lazy_static! {
            static ref VALUE: PyObject = {
                Python::with_gil(|py| {
    ...
    pub fn not_available() -> &'static PyObject {
        lazy_static::lazy_static! {
            static ref VALUE: PyObject = {
                Python::with_gil(|py| {
    ...
    pub fn bad_recipient() -> &'static PyObject {
        lazy_static::lazy_static! {
            static ref VALUE: PyObject = {
                Python::with_gil(|py| {
...
impl RealmRole {
    ...
    #[classattr]
    #[pyo3(name = "MANAGER")]
    pub fn manager() -> &'static PyObject {
        lazy_static::lazy_static! {
            static ref VALUE: PyObject = {
                Python::with_gil(|py| {
    ...
    pub fn contributor() -> &'static PyObject {
        lazy_static::lazy_static! {
            static ref VALUE: PyObject = {
                Python::with_gil(|py| {
